...
saveRDS(base_rf, file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/models/base_rf.rds")
saveRDS(dig_rf, file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/models/dig_rf.rds")
...
write_csv(base_results, file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/models/base_results.csv")

capture.output(print(base_rf), file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/models/base_rf_summary")

#Digital model
dig_results <- data.frame(Actual = dig_true, Predictied = dig_predict, 
                           MSE = mse_dig, MAE = mae_dig, Psuedo_r2 = psuedo_r2_dig)
write_csv(dig_results, file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/models/digital_results.csv")

capture.output(print(dig_rf), file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/models/digital_rf_summary")
