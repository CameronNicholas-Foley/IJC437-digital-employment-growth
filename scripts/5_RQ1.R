...
ggsave("figure9_rq1.png", plot = rq1_digital_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
print(rq1_hhi_plot)
ggsave("figure10_rq1.png", plot = rq1_hhi_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure11_rq1.png", plot = rq1_education_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure12_rq1.png", plot = rq1_net_business_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
