...
#Loading data set 
bres_raw <- read_excel("IJC437-digital-connectivity-local-employment-growth-main/raw_data/bres/nomis_2026_01_07_102048.xlsx", col_names = FALSE)
...
ofcom_2015 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/Fixed_La_updated_2016.csv")
ofcom_2016 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/2016_fixed_laua_r01.csv")
ofcom_2017 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/fixed_la_2017.csv")
ofcom_2018 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/201805_fixed_laua_r02.csv")
ofcom_2019 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/201905_fixed_laua_r01.csv")
ofcom_2020 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/202006_fixed_laua_r02.csv")
ofcom_2021 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/202105_fixed_laua_r01.csv")
ofcom_2022 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/202205_fixed_laua_r02.csv")
ofcom_2023 <- read_csv("IJC437-digital-connectivity-local-employment-growth-main/raw_data/ofcom/202305_fixed_laua_r01.csv")
...
ofcom_list$`2015` <- ofcom_list$`2015`%>%
  rename("laua_name" = "Local Authority Name",
         "Average download speed (Mbit/s)" = "Average download speed (Mbit/s) by Local Authority",
         "Average upload speed (Mbit/s)" = "Average upload speed (Mbit/s) by Local Authority",
  )
...
dfe_raw <- read_excel("IJC437-digital-connectivity-local-employment-growth-main/raw_data/dfe/level_2_3_la_figures_trimmed.xlsx")
...
bd_2020_raw <- bd_2020_sheets%>%
  set_names()%>%
  map(~ read_excel("IJC437-digital-connectivity-local-employment-growth-main/raw_data/business_demog/business_demog2020.xlsx", sheet = .x))

bd_2023_raw <- bd_2023_sheets%>%
  set_names()%>%
  map(~ read_excel("IJC437-digital-connectivity-local-employment-growth-main/raw_data/business_demog/business_demog2023.xlsx", sheet = .x))
...
View(data_processed)
write.csv(data_processed, file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/tables/data_processed.csv")
...
#Pivoting indsutry data longer and computing industry shares per LA
...
View(data_eda)
write_csv(data_eda, file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/tables/data_eda.csv")
