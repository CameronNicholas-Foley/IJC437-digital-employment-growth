...
ofcom_2015 <- read_csv("raw_data/ofcom/Fixed_Local_Authority_updated_01022016.csv")
ofcom_2016 <- read_csv("raw_data/ofcom/2016_fixed_laua_r01.csv")
ofcom_2017 <- read_csv("raw_data/ofcom/fixed-local-authority-2017.csv")
ofcom_2018 <- read_csv("raw_data/ofcom/201805_fixed_laua_performance_r02.csv")
ofcom_2019 <- read_csv("raw_data/ofcom/201905_fixed_laua_performance_r01.csv")
ofcom_2020 <- read_csv("raw_data/ofcom/202006_fixed_laua_performance_r02.csv")
ofcom_2021 <- read_csv("raw_data/ofcom/202105_fixed_laua_performance_r01.csv")
ofcom_2022 <- read_csv("raw_data/ofcom/202205_fixed_laua_performance_r02.csv")
ofcom_2023 <- read_csv("raw_data/ofcom/202305_fixed_laua_performance_r01.csv")
...
dfe_raw <- read_excel("raw_data/dfe/level_2_3_ages_16_19_local_authority_figures_trimmed.xlsx")
...
bd_2020_raw <- bd_2020_sheets%>%
  set_names()%>%
  map(~ read_excel("raw_data/business_demography/businessdemographyexceltables2020.xlsx", sheet = .x))

bd_2023_raw <- bd_2023_sheets%>%
  set_names()%>%
  map(~ read_excel("raw_data/business_demography/businessdemographyexceltables2023.xlsx", sheet = .x))
