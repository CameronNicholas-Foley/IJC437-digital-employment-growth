...
ofcom_2018 <- read_csv("raw_data/ofcom/201805_fixed_laua_r02.csv")
ofcom_2019 <- read_csv("raw_data/ofcom/201905_fixed_laua_r01.csv")
ofcom_2020 <- read_csv("raw_data/ofcom/202006_fixed_laua_r02.csv")
ofcom_2021 <- read_csv("raw_data/ofcom/202105_fixed_laua_r01.csv")
ofcom_2022 <- read_csv("raw_data/ofcom/202205_fixed_laua_r02.csv")
ofcom_2023 <- read_csv("raw_data/ofcom/202305_fixed_laua_r01.csv")
...
bd_2020_raw <- bd_2020_sheets%>%
  set_names()%>%
  map(~ read_excel("raw_data/business_demography/business_demog2020.xlsx", sheet = .x))

bd_2023_raw <- bd_2023_sheets%>%
  set_names()%>%
  map(~ read_excel("raw_data/business_demography/business_demog2023.xlsx", sheet = .x))
