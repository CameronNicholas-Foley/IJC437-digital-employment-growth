...
eda_dig_means_plot <- year_dig_summary%>%
  ...
  labs(title = "Regional Mean Downloads and Upload Speeds Over Time", 
       x = "Year", y = "Speed (Mbit/s)", colour = "",
...
eda_dig_dispersion_plot <- data_eda%>%
  ...
  labs(title = "Distribution of Download Speeds Across LAs Over Time", 
       x = "Year", y = "Download Speeds (Mbit/s)",
       caption = "Ofcom Connected Nations (2015-2023)")+
  theme_minimal()+
  theme(title = element_text(face = "bold"), 
        axis.title.x = element_text(face = "bold"),
...
eda_lin_test_plot <- lin_test_df%>% #----------------FIX THIS
  ...
  labs(title = "Scatterplot Matrix Testing for Assumptions of Linearity", 
       x = "Indicator", y = "Employment Growth (%)")+
  theme_minimal()+
  theme(title = element_text(face = "bold"), 
        axis.title.x = element_text(face = "bold"),
        axis.title.y = element_text(face = "bold"))
