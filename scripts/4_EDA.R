...
print(table3_eda)
write_csv(table3_eda, file = "IJC437-digital-connectivity-local-employment-growth-main/outputs/tables/table3_eda.csv")
...
ggsave("figure2_eda.png", plot = eda_growth_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure3_eda.png", plot = eda_dig_means_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure4_eda.png", plot = eda_dig_dispersion_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure5_eda.png", plot = eda_group_industry_share_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure6_eda.png", plot = eda_attainment_summary_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure7_eda.png", plot = eda_demography_summary_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
...
ggsave("figure8_eda.png", plot = eda_lin_test_plot, path = "IJC437-digital-connectivity-local-employment-growth-main/outputs/figures")
